import {getCurrentItem} from 'src/core/utils/ChartDataUtil';
...
> {
  ...
  public render() {
    const {x1Value, x2Value, appearance, edgeInteractiveCursor, hoverText, interactive, selected, onDragComplete} =
      this.props;
