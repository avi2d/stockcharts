...
import {ChartContext, GenericChartComponent, getMouseCanvas, isDefined, noop} from 'src/core';
  ...
  public render() {
    ...
    return (
      <g>
        ...
        <GenericChartComponent canvasToDraw={getMouseCanvas} drawOn={['mousemove', 'pan']} onClick={this.handleDraw} />;
      </g>
    );
  }
