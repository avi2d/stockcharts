  ...
  public render() {
    ...
    return (
      <g className={className}>
        <LineSeries strokeStyle={strokeStyle.top} yAccessor={this.yAccessorForTop} />
        <LineSeries strokeStyle={strokeStyle.middle} yAccessor={this.yAccessorForMiddle} />
        <LineSeries strokeStyle={strokeStyle.bottom} yAccessor={this.yAccessorForBottom} />
        <AreaOnlySeries base={this.yAccessorForScaledBottom} fillStyle={fillStyle} yAccessor={this.yAccessorForTop} />
      </g>
    );
  }
