...
import {functor, isDefined, getAxisCanvas, GenericChartComponent} from 'src/core';
...
export class OHLCSeries extends React.Component<OHLCSeriesProps> {
  ...
  public render() {
    ...
    return (
      <GenericChartComponent canvasDraw={this.drawOnCanvas} canvasToDraw={getAxisCanvas} clip={clip} drawOn={['pan']} />
    );
  }
  ...
  private readonly getOHLCBars = (props: OHLCSeriesProps, xAccessor: any, xScale: any, yScale: any, plotData: any) => {
