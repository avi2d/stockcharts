    ...
    return (
      <defs>
        <clipPath id={this.clipPathId1}>
          <rect height={yScale(overBought) - yScale(overSold)} width={width} x={0} y={yScale(overSold)} />
        </clipPath>
        <clipPath id={this.clipPathId2}>
          <rect height={yScale(overSold)} width={width} x={0} y={0} />
          <rect height={height - yScale(overBought)} width={width} x={0} y={yScale(overBought)} />
        </clipPath>
      </defs>
    );
  };
