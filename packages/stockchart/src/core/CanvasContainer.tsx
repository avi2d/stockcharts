  ...
  public render() {
    ...
    return (
      <div style={{...style, position: 'absolute'}}>
        <canvas ref={this.bgRef} height={adjustedHeight} style={canvasStyle} width={adjustedWidth} />
        <canvas ref={this.axesRef} height={adjustedHeight} style={canvasStyle} width={adjustedWidth} />
        <canvas ref={this.mouseRef} height={adjustedHeight} style={canvasStyle} width={adjustedWidth} />
      </div>
    );
  }
}
