...
export class BarAnnotation extends React.Component<BarAnnotationProps> {
  public static defaultProps = {
    ...
    textIconFill: '#000000',
    textIconFontSize: 10,
    x: ({xScale, xAccessor, datum}: {xScale: ScaleContinuousNumeric<number, number>; xAccessor: any; datum: any}) =>
  ...
  public render() {
    ...
    return (
      <g className={className} onClick={this.onClick}>
        ...
        {path !== undefined ? <path d={path({x, y})} fill={fill} opacity={opacity} stroke={stroke} /> : null}
      </g>
    );
  }
